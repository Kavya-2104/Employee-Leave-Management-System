...
$(document).ready(function () {
    ...
    <div class="dashboard-nav">
        ...
        <a href="addemployee" class="dashboard-nav-item"><i class="fas fa-home"></i> Add Employee</a>
    ...
    <div style="margin-left: 450px; -webkit-text-fill-color: #fff;">
        <h1>
...
<br>
 ...
 <img src="https://flowhcm.com/wp-content/uploads/2023/01/MicrosoftTeams-image-379.png">
