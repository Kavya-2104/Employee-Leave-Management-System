...
<head>
  ...
  <style>
    ...
    .table-container {
      ...
      text-align: center;
      margin: 0 auto;
      background-color: #fff; /* Set the background color of the table container */
    }
...
<div style="margin-left: 350px;">
    ...
    <div class="table-container">
        <table class="styled-table">
            ...
            <tbody>
            <c:forEach items="${managerdata}" var="manager">
                <tr>
                    <td><c:out value="${manager.managerid}" /></td>
                    <td><c:out value="${manager.name}" /></td>
                    <td><c:out value="${manager.gender}" /></td>
                    <td><c:out value="${manager.dob}" /></td>
                    <td><c:out value="${manager.dept}" /></td>
                    <td><c:out value="${manager.designation}" /></td>
                    <td><c:out value="${manager.email}" /></td>
                    <td><c:out value="${manager.contact}" /></td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
